...
The control software is written in Objective-C++ with openFrameworks. It renders Perlin noise-driven light patterns across the tessellated LED array and outputs PDF visualisations of the tessellation geometry.
